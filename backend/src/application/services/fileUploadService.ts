...
// Asegurarse de que el directorio de uploads/cv exista
const uploadDir = path.join(__dirname, '../../infrastructure/fs/uploads/cv');
...
const storage = multer.diskStorage({
    destination: function (req, file, cb) {
        cb(null, uploadDir);  // Usar la variable uploadDir
    },
